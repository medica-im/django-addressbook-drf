    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Work', 'Work'), ('Personal', 'Personal'), ('Portfolio', 'Portfolio'), ('Blog', 'Blog')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Skype', 'Skype'), ('Twitter', 'Twitter'), ('LinkedIn', 'LinkedIn'), ('Facebook', 'Facebook'), ('Pinterest', 'Pinterest')], max_length=255)),
                ('public_visible', models.BooleanField(default=False)),
                ('contact_visible', models.BooleanField(default=False)),
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='addressbook.contact')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Mobile', 'Mobile'), ('Mobile Work', 'Mobile Work'), ('Work', 'Work'), ('Fax', 'Fax'), ('Skype', 'Skype')], max_length=255)),
                ('public_visible', models.BooleanField(default=False)),
                ('contact_visible', models.BooleanField(default=False)),
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='addressbook.contact')),
            ],
